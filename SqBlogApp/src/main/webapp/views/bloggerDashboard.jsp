...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
		...
		<ul class="navbar-nav">
			...
			<li><a href="Pending_Blogs" target="_blank"><button
						type="button" class="btn btn-warning">Pending Blogs</button>&nbsp;&nbsp;&nbsp;</a></li>
			<li><a href="Approved_Blogs" target="_blank"><button
						type="button" class="btn btn-success">Approved Blogs</button>&nbsp;&nbsp;&nbsp;</a></li>
